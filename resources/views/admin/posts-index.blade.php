                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <select class="form-control" id="category" name="category">
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->id }}" @if (request()->get('category') == $category->id) selected="selected" @endif>{{ $category->name }}
                                </option>
                            @endforeach
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <select class="form-control" id="location" name="location">
                            ...
                            @foreach ($locations as $location)
                                <option value="{{ $location->id }}" @if (request()->get('location') == $location->id) selected="selected" @endif>{{ $location->name }}
                                </option>
                            @endforeach
