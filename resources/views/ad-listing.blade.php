            ...
            <form action="#">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mr-lg-auto my-2">
                                    <select name="sub_category_id" class="w-100">
                                        <option value="" hidden>Sub category</option>
                                        <option value="">nvbkjg</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="price">
                                ...
                                <div class="row px-3">
                                    ...
                                    <div class="col-lg-4 rounded bg-white my-2 ">
                                        <select name="is_negotiable" id="state" class="w-100">
                ...
                <fieldset class="border p-4 my-5 seller-information bg-gray">
                    <div class="row">
                        ...
                        <div class="choose-file text-center my-4 py-4 rounded col-lg-12">
