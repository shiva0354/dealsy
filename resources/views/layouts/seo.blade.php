...
<meta name="og:description" content="{{ $seo->meta_description ?? config('seo.og_description') }}">
...
<meta name="twitter:title" content="{{ $seo->meta_title ?? config('seo.twitter_title') }}">
<meta name="twitter:description" content="{{ $seo->twitter_description ?? config('seo.twitter_description') }}">
...
<meta name="description" content="{{ $seo->meta_description ?? config('seo.meta_description') }}">
<title>{{ $seo->meta_title ?? config('seo.meta_title') }}</title>
